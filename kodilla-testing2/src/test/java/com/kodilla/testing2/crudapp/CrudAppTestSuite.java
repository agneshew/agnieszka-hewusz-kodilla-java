...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://agneshew.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("agnieszkahewusz");
        driverTrello.findElement(By.id("password")).sendKeys("mojehaslo");
